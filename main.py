...
best_1 = NeuralNetworkModel(hidden_layers=[128], epochs=400, learning_rate=0.01, optimizer='adam',activation_function='relu', id=1)
# two hidden layers
...
best_2 = NeuralNetworkModel(hidden_layers=[128,128], epochs=400, learning_rate=0.01, optimizer='adam',activation_function='relu', id=2)
# three hidden layers
...
best_3 = NeuralNetworkModel(hidden_layers=[128,128,128], epochs=400, learning_rate=0.01, optimizer='adam',activation_function='relu', id=3)
